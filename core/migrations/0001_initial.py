# Generated by Django 6.0.6 on 2026-07-12 02:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mensaje', models.TextField(blank=True, help_text='Mensaje opcional del huésped al afectado', null=True)),
                ('comentario', models.TextField(blank=True, help_text='Comentario sobre el estado del match', null=True)),
                ...
                ('afectado', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='matches_recibidos', to='core.afectado')),
                ('huesped', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='matches_enviados', to='core.huesped')),
            ],
            options={
                'verbose_name': 'Match',
